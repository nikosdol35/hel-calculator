...
**Version:** 1.10 (Phase 3 UI redesign PR 2: §5.3 items 8–11 tightened with the final metric-card / status-chip / severity-sorted-flag-list behavior shipped in code — **no physics, no module I/O, no validation-case expected values touched**)
